...
# все не в порядке
# Ввод:                                       Вывод:
# пара-ра-рам рам-пам-папам па-ра-па-дам      Парам пам-па
...
str_1 = input('Дорогой Винни-Пух, набери стихотворение, не забыая разделять разные фразы пробелами, а слова во фразе - дефисами: ')
if rhyme(str_1):
    print('Парам пам-пам')
else:
    print('Пам парам')